...
const description = 'פוטנציאל להתחלות חדשות, צורך חזק בדברים חדשים שלא היו קודם, הזדמנויות להתחבר לאינדיבידואל ולרצונות, אפשרויות חדשות נכנסות לחיים בכל תחום, החיים דוחפים את האדם לעמוד על שתי רגליו, להיות עצמאי יותר בין אם זהו טבעו ובין אם לא.\n' +
